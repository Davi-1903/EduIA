        ...
        <footer className='bg-footer'>
            <div className='mx-auto flex max-w-360 flex-col justify-between gap-4 p-4 sm:p-12 lg:flex-row'>
                <article className='lg:max-w-md'>
                    ...
                    <p className='text-md/normal font-primary text-color1-normal text-balance'>
                        ...
                        <li>
                            <Link to='https://github.com/Davi-1903/EduIA' target='_blank'>
                                <IconBrandGithub
                                    size={32}
                                    strokeWidth={2}
                                    className='stroke-color1-normal hover:bg-color3-dark box-content rounded-lg p-2'
                                />
                            </Link>
                        </li>
                    </ul>
                    <button
                        className='border-color1-normal hover:bg-color1-normal text-color1-normal hover:stroke-color3-normal stroke-color1-normal hover:text-color3-normal flex cursor-pointer gap-2 rounded-lg border-3 px-4 py-2 transition-all duration-100'
                ...
                <div className='flex flex-col gap-4 md:flex-row lg:w-160'>
                    <article className='flex-1'>
                        <h2 className='font-primary text-color1-normal mb-2 text-xl font-bold md:text-2xl'>
                            Funcionalidades
                        </h2>
                        <ul>
                            {funcionalidades.map((material, idx) => (
                                <li key={idx}>
                                    <Link to='/about' className='font-primary text-color1-normal hover:underline'>
                                        Gerar {material}
                                    </Link>
                                </li>
                            ))}
                        ...
                        <ul>
                            ...
                            <li>
                                <Link
                                    ...
                                    target='_blank'
                                    className='font-primary text-color1-normal hover:underline'
                                >
            ...
            <p className='font-primary bg-color1-dark text-color3-normal p-4 text-center text-sm'>
