...
import { IconArrowLeft, IconBrandGoogle, IconEye, IconEyeOff, IconMail } from '@tabler/icons-react';
...
export default function SignIn() {
    ...
    return (
        <main className='grid min-h-screen grid-cols-1 md:grid-cols-[3fr_2fr] lg:grid-cols-[2fr_3fr]'>
            <article className='bg-color3-200 grid place-items-center'>
                ...
                <form className='box-content flex w-80 flex-col gap-4 p-8'>
