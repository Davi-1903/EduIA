            ...
            <main className='bg-color4-200 flex min-h-screen items-center justify-center gap-8 p-8 md:p-24'>
                ...
                <article className='flex-1 text-center md:text-left'>
                    ...
                    <Link to={isAuthenticated ? '/dash' : '/'}>
                        <button className='bg-button text-color4-200 font-primary hover:shadow-lg-hard text-md mt-6 cursor-pointer rounded-xl px-4 py-4 transition-all duration-200 md:px-8 md:text-xl'>
