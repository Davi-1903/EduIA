    ...
    return (
            ...
            className={clsx( 'fixed inset-0 z-7 grid place-items-center bg-gray-800/20 backdrop-blur-sm',
                ...
                <form className="bg-color4-200 px-6 py-12 flex w-xl flex-col gap-6 rounded-2xl"
                    ...
                    <div>
                        <label className="font-bold font-secundary text-color1-100">Formato dos exercícios</label>
                    ...
                    <div className="flex flex-col">
                        <label className="font-bold font-secundary text-color1-100">Observação</label>
                        <textarea placeholder='Escreva algo específico que deseja nos exercícios...' 
                                  className="px-4 py-2 bg-color4-200 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-color1-400'"
                        ></textarea>
                    </div>
