export default function Introduction({ subject, difficulty, questionsLength, handleStart }) {
    return (
        <article className='flex flex-col items-center gap-6'>
            ...
            <p className='text-center text-[1.2rem] font-bold text-color2-100'>0/{questionsLength}</p>
            <button
