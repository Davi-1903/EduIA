...
export default function Introduction({ discipline, subject, difficulty, cardsLength, handleClose, handleStart }) {
    const informations = [
        {
            id: 1,
            icon: (
    ...
    return (
        <article className='flex flex-col gap-6'>
            <div className='flex items-center gap-2'>
                ...
                />
                <span className='font-secundary text-sm font-bold text-color1-400'>PREPARAÇÃO PARA FLASHCARDS</span>
            </div>
            ...
            <blockquote className='flex items-center gap-3 rounded-lg bg-color4-100 p-4'>
                ...
                <p className='font-secundary text-base text-color1-100'>
                    Leia cada questão com atenção. Você pode voltar os cartões quando desejar.
                </p>
            </blockquote>
