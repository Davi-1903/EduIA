import { IconAlertCircle, IconArrowRight, IconBook, IconBook2, IconBrandSpeedtest, IconSchool } from '@tabler/icons-react';

export default function Introduction({ discipline, subject, difficulty, handleClose, handleStart }) {
    const informations = [
        {
            id: 1,
            icon: (
        ...
        },
        {
            ...
            type: 'Dificuldade',
            content: difficulty ?? 'Muito Dificil',
        },
    ];
    ...
    return (
        <article className='flex flex-col gap-6'>
            <div className='flex items-center gap-2'>
                ...
                />
                <span className='font-secundary text-sm font-bold text-color1-400'>PREPARAÇÃO PARA DESAFIO</span>
            </div>
            ...
            <blockquote className='flex items-center gap-3 rounded-lg bg-color4-100 p-4'>
                ...
                <p className='font-secundary text-base text-color1-100'>
                    Leia o desafio com atenção e escreva sua resolução com calma antes de enviar.
                </p>
            </blockquote>
